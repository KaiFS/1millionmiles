...
export const metadata: Metadata = {
  title: 'Privacy Policy | The One Million Miles Challenge',
  description: 'How the One Million Miles Challenge collects, uses, and protects your data.',
}
...
export default function PrivacyPage() {
  return (
    <StaticPageShell title="Privacy Policy">
      ...
      <h3 style={{ fontSize: 16, marginTop: 24, marginBottom: 12, color: '#fff' }}>1. Introduction</h3>
      ...
      <h3 style={{ fontSize: 16, marginTop: 24, marginBottom: 12, color: '#fff' }}>2. Information We Collect</h3>
      ...
      <h3 style={{ fontSize: 16, marginTop: 24, marginBottom: 12, color: '#fff' }}>3. How We Use Your Information</h3>
      <p style={{ marginBottom: 12 }}>We use the collected information to:</p>
      <ul style={{ marginBottom: 12, paddingLeft: 20 }}>
        <li style={{ marginBottom: 8 }}>Display your contributions on the public leaderboard and recent activity feed</li>
        <li style={{ marginBottom: 8 }}>Track your personal progress toward the one million mile goal</li>
        <li style={{ marginBottom: 8 }}>Verify activity submissions through optional screenshot proofs</li>
      ...
      <h3 style={{ fontSize: 16, marginTop: 24, marginBottom: 12, color: '#fff' }}>4. Public Leaderboard</h3>
      <p style={{ marginBottom: 12 }}>
      ...
      <h3 style={{ fontSize: 16, marginTop: 24, marginBottom: 12, color: '#fff' }}>5. Data Sharing and Disclosure</h3>
      <p style={{ marginBottom: 12 }}>
        We do not sell your personal information. We may share data in the following
        circumstances:
      </p>
      <ul style={{ marginBottom: 12, paddingLeft: 20 }}>
        <li style={{ marginBottom: 8 }}>With Evelina London Children&apos;s Hospital as the beneficiary charity</li>
        <li style={{ marginBottom: 8 }}>
          With service providers (Supabase, Google) who help operate the app under strict
          data protection agreements
        </li>
        <li style={{ marginBottom: 8 }}>When required by law or to protect our rights and safety</li>
      </ul>

      <h3 style={{ fontSize: 16, marginTop: 24, marginBottom: 12, color: '#fff' }}>6. Data Security</h3>
      <p style={{ marginBottom: 12 }}>
      ...
      <h3 style={{ fontSize: 16, marginTop: 24, marginBottom: 12, color: '#fff' }}>7. Your Rights</h3>
      ...
      <h3 style={{ fontSize: 16, marginTop: 24, marginBottom: 12, color: '#fff' }}>8. Data Retention</h3>
      <p style={{ marginBottom: 12 }}>
      ...
      <h3 style={{ fontSize: 16, marginTop: 24, marginBottom: 12, color: '#fff' }}>9. Children&apos;s Privacy</h3>
      <p style={{ marginBottom: 12 }}>
        Our services are not intended for children under 13. We do not knowingly collect
        personal information from children under 13.
      </p>

      <h3 style={{ fontSize: 16, marginTop: 24, marginBottom: 12, color: '#fff' }}>10. Changes to This Policy</h3>
      <p style={{ marginBottom: 12 }}>
        We may update this Privacy Policy from time to time. We will notify you of any changes
        by posting the new policy on this page and updating the &#34;Last updated&#34; date.
      </p>

      <h3 style={{ fontSize: 16, marginTop: 24, marginBottom: 12, color: '#fff' }}>11. Contact Us</h3>
      <p style={{ marginBottom: 12 }}>
